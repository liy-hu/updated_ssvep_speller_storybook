...
screen word_file_based ():
    ...
    use game_menu(_("Word File Based Preferences"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("Dolch Kindergarten") action SetField(persistent, "difficulty", 0):
                        if persistent.custom_change == True:
                            action SetField(persistent, "custom_change", False)
                    textbutton _("Dolch 1st Grade") action SetField(persistent, "difficulty", 1):
                        if persistent.custom_change == True:
                            action SetField(persistent, "custom_change", False)
                    textbutton _("Dolch 2nd Grade") action SetField(persistent, "difficulty", 2):
                        if persistent.custom_change == True:
                            action SetField(persistent, "custom_change", False)
                    textbutton _("Dolch 3rd Grade") action SetField(persistent, "difficulty", 3):
                        if persistent.custom_change == True:
                            action SetField(persistent, "custom_change", False)
                ...
                vbox:
                    ...
                    text "{=color_text}Input Word File Name{/color}"
                    imagemap:
                        idle "inputbox.png"
                        hover "inputboxhover.png"
                        selected_idle "inputbox.png"

                        hotspot (0, 0, 447, 125) action SetScreenVariable("word_file_screenvar",True)
...
screen word_length_based ():
    ...
    use game_menu(_("Length Based Preferences"), scroll="viewport"):
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("2 Letter Words")action SetField(persistent, "difficulty", -1):
                        if persistent.custom_change == True:
                            action SetField(persistent, "custom_change", False)
                    textbutton _("3 Letter Words") action SetField(persistent, "difficulty", 0):
                        if persistent.custom_change == True:
                            action SetField(persistent, "custom_change", False)

                    textbutton _("4 Letter Words") action SetField(persistent, "difficulty", 1):
                        if persistent.custom_change == True:
                            action SetField(persistent, "custom_change", False)
                ...
                vbox:
                    ...
                    text "{=color_text}Input Word Length {/color}"
                    imagemap:
                        idle "inputbox.png"
                        hover "inputboxhover.png"
                        selected_idle "inputbox.png"

                        hotspot (0, 0, 447, 125) action SetScreenVariable("length_screenvar",True)
...
screen story_choices():
    ...
    use game_menu(_("Story Selection"), scroll="viewport"):
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    xpos 100
                    label _("Custom Story")
                    text "{=color_text}Input Story Name{/color}"
                    imagemap:
                        ypos 5
                        idle "inputbox.png"
                        hover "inputboxhover.png"
                        ...
                        hotspot (0, 0, 447, 125) action SetScreenVariable("story_name_screenvar",True)
...
screen invalid_input_error (preference_type):
    ...
    vbox:
        text "{=color_invalid_text}Invalid [preference_type] Input. \nTo re-enter a custom input please return to preferences.{/color}"
        xalign 0.5
        yalign 0.5
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("Length Based") action [SetField(persistent, "type", "length"), ShowMenu("word_length_based")]
                ...
                vbox:
                    ...
                    textbutton _("Here Comes the Sun") action SetField( persistent, "song_choice", "Here Comes The Sun")
